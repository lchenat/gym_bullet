...
class WalkerBase(MJCFBasedRobot):
	...
	def calc_state(self):
		...
		return np.clip( np.concatenate([[self.d]] + [more] + [j] + [self.feet_contact]), -5, +5)
...
class Hopper(WalkerBase):
	...
	def __init__(self):
		WalkerBase.__init__(self, "hopper.xml", "torso", action_dim=3, obs_dim=16, power=0.75)
...
class HalfCheetah(WalkerBase):
	...
	def __init__(self):
		WalkerBase.__init__(self, "half_cheetah.xml", "torso", action_dim=6, obs_dim=27, power=0.90)
...
class Ant(WalkerBase):
	...
	def __init__(self):
		WalkerBase.__init__(self, "ant.xml", "torso", action_dim=8, obs_dim=29, power=2.5)
...
class Swimmer(WalkerBase):
	...
	def __init__(self):
		WalkerBase.__init__(self, "swimmer.xml", "torso", action_dim=2, obs_dim=13, power=2.0)	
...
class Ant6(WalkerBase):
	...
	def __init__(self):
		WalkerBase.__init__(self, "ant6.xml", "torso", action_dim=12, obs_dim=33, power=2.5)
...
class Humanoid(WalkerBase):
	...
	def __init__(self):
		WalkerBase.__init__(self, 'humanoid_symmetric.xml', 'torso', action_dim=17, obs_dim=45, power=0.41)
