...
from pybullet_my_envs.scene_abstract import Scene
...
class StadiumScene(Scene):
	...
	def episode_restart(self):
		...
		filename = os.path.join(pybullet_my_data.getDataPath(),"stadium_no_collision.sdf")
		self.stadium = p.loadSDF(filename)
		planeName = os.path.join(pybullet_my_data.getDataPath(),"mjcf/ground_plane.xml")
